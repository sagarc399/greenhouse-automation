<template>
  <div class="min-h-screen bg-gradient-to-br from-greenhouse-800 to-greenhouse-600 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
      <div class="text-center mb-8">
        <div class="text-6xl mb-4">🌱</div>
        <h1 class="text-2xl font-bold text-gray-900">{{ $t('auth.loginDesc') }}</h1>
